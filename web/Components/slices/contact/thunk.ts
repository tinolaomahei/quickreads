...
export const addNewContact = createAsyncThunk("contact/addNewContact", async (contact: any) => {
    try {
...
export const updateContact = createAsyncThunk("contact/updateContact", async (contact: any) => {
    try {
...
export const deleteContact = createAsyncThunk("contact/deleteContact", async (contact: any) => {
    try {
