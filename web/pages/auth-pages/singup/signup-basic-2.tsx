                        ...
                        <Col lg={7}>
                            <Card className="mb-0 rounded-0 rounded-end border-0">
                                <Card.Body className="p-4 p-sm-5 m-lg-4">
                                        ...
                                        <form className="needs-validation" noValidate action="#">
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <div className="input-group">
                                                    <span className="input-group-text bg-card-custom" id="basic-addon1"><i className="ri-mail-line"></i></span>
                                    ...
                                    <div className="mt-4 text-center">
                                        <p className="mb-0">Already have an account ? <Link href="/auth-pages/login/signin-basic-2" className="fw-semibold text-primary text-decoration-underline"> Signin </Link> </p>
                                    </div>
                                </Card.Body>
                            </Card>
                        </Col>
